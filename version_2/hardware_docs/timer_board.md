...
9. `MAIN-TIMER` - 8-bit section of the 36 bit main timer. Addressed by the `INT-AND-MAIN-TIMER-ADDRESS` (see above). Bits indexed are as follows based on that address: 0 -> 4-11, 1 -> 12-19, 2 -> 20-27, 3 -> 28-35.
